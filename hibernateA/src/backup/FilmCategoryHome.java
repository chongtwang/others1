...
public class FilmCategoryHome {
	...
	public FilmCategory merge(FilmCategory detachedInstance) {
		...
		try {
			FilmCategory result = (FilmCategory) sessionFactory
	...
	public FilmCategory findById(FilmCategoryId id) {
		...
		try {
			FilmCategory instance = (FilmCategory) sessionFactory
					.getCurrentSession().get("FilmCategory", id);
			if (instance == null) {
	...
	public List<FilmCategory> findByExample(FilmCategory instance) {
		...
		try {
			List<FilmCategory> results = (List<FilmCategory>) sessionFactory
					.getCurrentSession().createCriteria("FilmCategory")
