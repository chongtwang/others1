...
public class SalesByFilmCategoryHome {
	...
	private static final Log log = LogFactory
			.getLog(SalesByFilmCategoryHome.class);
	...
	public SalesByFilmCategory merge(SalesByFilmCategory detachedInstance) {
		...
		try {
			SalesByFilmCategory result = (SalesByFilmCategory) sessionFactory
	...
	public SalesByFilmCategory findById(SalesByFilmCategoryId id) {
		...
		try {
			SalesByFilmCategory instance = (SalesByFilmCategory) sessionFactory
					.getCurrentSession().get("SalesByFilmCategory", id);
			if (instance == null) {
	...
	public List<SalesByFilmCategory> findByExample(SalesByFilmCategory instance) {
		...
		try {
			List<SalesByFilmCategory> results = (List<SalesByFilmCategory>) sessionFactory
					.getCurrentSession().createCriteria("SalesByFilmCategory")
