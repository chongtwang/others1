...
public class ActorInfoHome {
	...
	public ActorInfo merge(ActorInfo detachedInstance) {
		...
		try {
			ActorInfo result = (ActorInfo) sessionFactory.getCurrentSession()
	...
	public List<ActorInfo> findByExample(ActorInfo instance) {
		...
		try {
			List<ActorInfo> results = (List<ActorInfo>) sessionFactory
					.getCurrentSession().createCriteria("ActorInfo")
