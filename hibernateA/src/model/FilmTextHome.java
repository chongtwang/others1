...
public class FilmTextHome {
	...
	public FilmText merge(FilmText detachedInstance) {
		...
		try {
			FilmText result = (FilmText) sessionFactory.getCurrentSession()
	...
	public FilmText findById(short id) {
		...
		try {
			FilmText instance = (FilmText) sessionFactory.getCurrentSession()
					.get("FilmText", id);
			if (instance == null) {
	...
	public List<FilmText> findByExample(FilmText instance) {
		...
		try {
			List<FilmText> results = (List<FilmText>) sessionFactory
					.getCurrentSession().createCriteria("FilmText")
