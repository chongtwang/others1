...
public class FilmListHome {
	...
	public FilmList merge(FilmList detachedInstance) {
		...
		try {
			FilmList result = (FilmList) sessionFactory.getCurrentSession()
	...
	public FilmList findById(FilmListId id) {
		...
		try {
			FilmList instance = (FilmList) sessionFactory.getCurrentSession()
					.get("FilmList", id);
			if (instance == null) {
	...
	public List<FilmList> findByExample(FilmList instance) {
		...
		try {
			List<FilmList> results = (List<FilmList>) sessionFactory
					.getCurrentSession().createCriteria("FilmList")
